...
"""
# Квадратичная сложность: функция рекурсивно вызывает саму себя столько раз, сумму скольких элементов требуется посчитать.
...
# Вывод: хотя разница, в данном примере, незначительна, всё же, первый алгоритм работает быстрее.